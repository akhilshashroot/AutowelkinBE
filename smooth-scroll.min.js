    ...
    var e = {
        ...
        n = function (e) {
            ...
            for (var t, n = String(e), o = n.length, a = -1, i = "", r = n.charCodeAt(0); ++a < o; ) {
                ...
                (t >= 1 && t <= 31) || 127 == t || (0 === a && t >= 48 && t <= 57) || (1 === a && t >= 48 && t <= 57 && 45 === r)
                    ? (i += "\\" + t.toString(16) + " ")
                    : (i += t >= 128 || 45 === t || 95 === t || (t >= 48 && t <= 57) || (t >= 65 && t <= 90) || (t >= 97 && t <= 122) ? n.charAt(a) : "\\" + n.charAt(a));
            }
            return "#" + i;
        },
        o = function () {
            ...
            (m.animateScroll = function (n, s, c) {
                ...
                if (h || p) {
                    ...
                    0 === window.pageYOffset && window.scrollTo(0, 0),
                        ...
                        "matchMedia" in window && window.matchMedia("(prefers-reduced-motion)").matches ? i(n, Math.floor(E), !1) : (r("scrollStart", l, n, s), m.cancelScroll(!0), window.requestAnimationFrame(A));
                }
            });
        var h = function (e) {
                if (
            ...
            p = function () {
                if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(u)) {
                    ...
                    ("string" == typeof e && e && !(e = document.querySelector(n(history.state.anchor)))) || m.animateScroll(e, null, { updateURL: !1 });
                }
            };
        m.destroy = function () {
