		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-3" id="m_login" style="background:#000000;">
                ...
                HASHROOT PE ADMIN
							...
							<form class="m-login__form m-form" method="POST" action="{{ route('admin.login.submit') }}" id="loginForm" style="margin-bottom:18px;">
                            {{ csrf_field() }}
                           
								<div class="form-group m-form__group">

                                    <input class="form-control m-input"  type="text" placeholder="Email" name="email" autocomplete="off" value="{{ old('email') }}"  autofocus>
...
-->
		...
		<script src="{{ asset('assets/Pejs/loginad.js')}}"  type="text/javascript"></script>
