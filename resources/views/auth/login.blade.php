...
<html lang="en" >
	...
	<head>
		...
		<link rel="shortcut icon" href="{{ asset('assets/media/img/user/favicon.ico')}}" />
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-3" id="m_login" style="background:#000000;">
				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					...
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" method="POST" action="{{ route('user.login.submit') }}" id="loginForm1" style="margin-bottom:18px;">
                            {{ csrf_field() }}
                           
								<div class="form-group m-form__group">

                                    <input class="form-control m-input"  type="email" placeholder="Email" name="email" autocomplete="off" value="{{ old('email') }}"  autofocus>
...
<!--						forgotten password-->
						...
						<div class="m-login__forget-password">
							...
							<form class="m-login__form m-form" id="forget-pas" method="POST" action="{{ route('password.email') }}">
                        @csrf
...
-->
		...
		<script src="{{ asset('assets/PeJs/login.js')}}"  type="text/javascript"></script>
